...
public interface ShoppingCartService {
    /**
     * Thêm mặt hàng vào giỏ hoặc tăng số lượng lên 1 nếu đã tồn tại * @param id là
     * mã mặt hàng cần thêm
     * 
    ...
    /**
     * Thay đổi số lượng lên của mặt hàng trong giỏ * @param id mã mặt hàng
     * 
